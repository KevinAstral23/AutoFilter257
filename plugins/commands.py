...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('📢 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 📢', url=f'https://t.me/{SUPPORT_CHAT}')
            ],[
            InlineKeyboardButton('ℹ️ 𝖧𝖤𝖫𝖯 ℹ️', url=f"https://t.me/{temp.U_NAME}?start=help")
            ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("🔍 𝖧𝖤𝖫𝖯 🔍", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("📢 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 📢", url="https://t.me/mkn_bots_updates")
            ],[      
            InlineKeyboardButton("ℹ️ 𝖧𝖤𝖫𝖯 ℹ️", callback_data="help"),
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton("🔍 𝖲𝖤𝖠𝖱𝖢𝖧 🔍", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("📢 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 📢", url="https://t.me/mkn_bots_updates")
            ],[      
            InlineKeyboardButton("ℹ️ 𝖧𝖤𝖫𝖯 ℹ️", callback_data="help"),
            InlineKeyboardButton("💫 𝖠𝖡𝖮𝖴𝖳 💫", callback_data="about")
