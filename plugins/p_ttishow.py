    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            k = await message.reply(
                text='<b>𝖨𝗆 𝖭𝗈𝗍 𝖠𝗅𝗅𝗈𝗐𝖾𝖽 𝖧𝖾𝗋𝖾 🐞\n\n𝖲𝗈𝗋𝗋𝗒 𝖢𝗈𝗇𝗍𝖺𝖼𝗍 𝖬𝗒 𝖮𝗐𝗇𝖾𝗋 𝖥𝗂𝗋𝗌𝗍...</b>',
        ...
        await message.reply_text(
            text=f"<b>›› 𝖢𝗈𝗆𝗆𝗂𝗌𝗌𝗂𝗈𝗇𝖾𝗋 𝖢𝗈𝗆𝖾 𝖠𝖻𝗈𝖺𝗋𝖽 \n›› 𝖢𝗈𝗆𝖾 𝖠𝖻𝗈𝖺𝗋𝖽.\n›› 𝗈𝗆𝖾 𝖠𝖻𝗈𝖺𝗋𝖽, 𝖧𝗈𝗐 𝖠𝗋𝖾 𝖸𝖺𝗅𝗅 𝖥𝗈𝗅𝗄𝗌 𝖣𝗈𝗂𝗇, 𝖠𝖭𝖣 𝖤𝖸𝖸! 𝖣𝗈𝗇𝗍 𝖥𝗈𝗋𝗀𝖾𝗍 𝖳𝗈 𝖬𝖺𝗄𝖾 𝖬𝖾 𝖠𝖽𝗆𝗂𝗇....</b>",
            reply_markup=reply_markup)
    else:
...
async def get_ststs(bot, message):
    rju = await message.reply('<b>𝖠𝖼𝖼𝖾𝗌𝗌𝗂𝗇𝗀 𝖲𝗍𝖺𝗍𝗎𝗌 𝖣𝖾𝗍𝖺𝗂𝗅𝗌...</b>')
