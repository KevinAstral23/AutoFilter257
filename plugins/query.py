...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if (st.status == enums.ChatMemberStatus.OWNER) or (str(userid) in ADMINS):
                ...
                await query.answer("𝖧𝗈𝗅𝖽 𝖮𝗇 𝖡𝗎𝖽𝖽𝗒 𝖳𝗁𝖺𝗍𝗌 𝖭𝗈𝗍 𝖥𝗈𝗋 𝖸𝗈𝗎 👨‍⚖️", show_alert=True)
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            InlineKeyboardButton("‼️ 𝖠𝖣𝖣 𝖬𝖤 𝖳𝖮 𝖸𝖮𝖴𝖱 𝖦𝖱𝖮𝖴𝖯 ‼️", url=f"http://t.me/{temp.U_NAME}?startgroup=true")
            ],[
            InlineKeyboardButton("🖇️ 𝖲𝖤𝖠𝖱𝖢𝖧 🖇️", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("🔔 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 🔔", url="https://t.me/mkn_bots_updates")
            ],[
            InlineKeyboardButton("‼️ 𝖧𝖤𝖫𝖯 ‼️", callback_data="help"),
            InlineKeyboardButton("🗞️ 𝖠𝖡𝖮𝖴𝖳 🗞️", callback_data="about")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('JSome', callback_data='son'),
            ...
            InlineKeyboardButton('🔮 𝖲𝖳𝖠𝖳𝖴𝖲 🔮', callback_data='stats')
            ],[
            InlineKeyboardButton('🚫 𝖢𝖫𝖮𝖲𝖤', callback_data='close_data'),
        ...
        buttons= [[
            InlineKeyboardButton('📜 𝖨𝖭𝖥𝖮 📜', callback_data='source')
            ],[
            InlineKeyboardButton('🏠 𝖧𝖮𝖬𝖤 🏠', callback_data='start'),
            InlineKeyboardButton('🔐 𝖢𝖫𝖮𝖲𝖤 🔐', callback_data='close_data')
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='https://t.me/k_ASTRA1')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('𝖡𝖺𝖼𝗄', callback_data='help'),
            InlineKeyboardButton('𝖡𝗎𝗍𝗍𝗍𝗈𝗇𝗌', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.edit_message_media(
        ...
        if settings is not None:
            buttons = [[
                ...
                InlineKeyboardButton('✅ 𝖸𝖤𝖲' if settings["botpm"] else '🗑️ 𝖭𝖮', callback_data=f'setgs#botpm#{settings["botpm"]}#{str(grp_id)}')
                ],[                
                InlineKeyboardButton('𝖥𝖨𝖫𝖤 𝖲𝖾𝖼𝗎𝗋𝖾', callback_data=f'setgs#file_secure#{settings["file_secure"]}#{str(grp_id)}'),
                InlineKeyboardButton('✅ 𝖸𝖤𝖲' if settings["file_secure"] else '🗑️ 𝖭𝖮',  callback_data=f'setgs#file_secure#{settings["file_secure"]}#{str(grp_id)}')
                ],[
                InlineKeyboardButton('𝖨𝖬𝖣𝖡', callback_data=f'setgs#imdb#{settings["imdb"]}#{str(grp_id)}'),
                InlineKeyboardButton('✅ 𝖸𝖤𝖲' if settings["imdb"] else '🗑️ 𝖭𝖮', callback_data=f'setgs#imdb#{settings["imdb"]}#{str(grp_id)}')
                ],[
                InlineKeyboardButton('𝖲𝖯𝖤𝖫𝖫 𝖢𝖧𝖤𝖢𝖪', callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}'),
                InlineKeyboardButton('✅ 𝖸𝖤𝖲' if settings["spell_check"] else '🗑️ 𝖭𝖮', callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}')
                ],[
                InlineKeyboardButton('𝖶𝖾𝗅𝖼𝗈𝗆', callback_data=f'setgs#welcome#{settings["welcome"]}#{str(grp_id)}'),
                InlineKeyboardButton('✅ 𝖸𝖤𝖲' if settings["welcome"] else '🗑️ 𝖭𝖮', callback_data=f'setgs#welcome#{settings["welcome"]}#{str(grp_id)}')               
            ]]
            reply_markup = InlineKeyboardMarkup(buttons)
