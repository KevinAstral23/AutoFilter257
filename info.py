...
START_MESSAGE = environ.get('START_MESSAGE', '👋 Hey {user}\n\nMy Name Is {bot},\nI offer movies, series, and filtering services for Telegram groups. Add me to your group for a seamless viewing experience....')
BUTTON_LOCK_TEXT = environ.get("BUTTON_LOCK_TEXT", "𝖧𝗈𝗅𝖽 𝖮𝗇 𝖥𝗈𝗋 𝖠 𝖲𝖾𝖼 𝖡𝗎𝖽𝖽𝗒 𝖳𝗁𝖺𝗍𝗌 𝖭𝗈𝗍 𝖭𝗈𝗍 𝖥𝗈𝗋 𝖸𝗈𝗎")
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', '𝖳𝗈 𝖴𝗌𝖾 𝖳𝗁𝗂𝗌 𝖡𝗈𝗍 𝖩𝗈𝗂𝗇 𝖳𝗁𝖾 𝖴𝗉𝖽𝖺𝗍𝖾𝗌 𝖢𝗁𝖺𝗇𝗇𝖾𝗅 𝖥𝗂𝗋𝗌𝗍!')
